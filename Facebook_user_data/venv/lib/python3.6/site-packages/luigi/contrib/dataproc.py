...
class CreateDataprocClusterTask(_DataprocBaseTask):
    ...
    main_node_type = luigi.Parameter(default="n1-standard-2")
    main_disk_size = luigi.Parameter(default="100")
    ...
    def run(self):
        ...
        cluster_conf = {
            ...
            "config": {
                ...
                "mainConfig": {
                    "numInstances": 1,
                    "machineTypeUri": base_uri + "/zones/" + self.gcloud_zone + "/machineTypes/" + self.main_node_type,
                    "diskConfig": {
                        "bootDiskSizeGb": self.main_disk_size,
                        "numLocalSsds": 0
                    }
                },
                "workerConfig": {
